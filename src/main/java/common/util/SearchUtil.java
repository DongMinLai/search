...
public class SearchUtil {
     ...
     * 获取表主键Field
     */
    public static Field getEntityTableIdField(Class<?> entity) throws NoSuchFieldException {
        for (Field field: getEntityFields(entity)
        ) {
            if(field.isAnnotationPresent(TableId.class)){
                return field;
     ...
     * @return
     */
    public static List<Object> getFieldValues(List<?> entities, Field field)
    {
     ...
     * @param value
     */
    public static void setFieldValues(List<Object> entity, Field field, Map<Object, List<Object>> value)
    {
        try {
            field.set(entity, value);
        } catch (IllegalAccessException e) {
            try {
                ...
                throw  new SearchException("无法注入结果");
            }
        }
    }
